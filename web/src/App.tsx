...
export function App() {
  return (
    <div className="mx-w-[1344px] mx-auto flex flex-col items-center my-8">
      ...
      <div className="pt-1 bg-nlw-gradient self-stretch mt-6 rounded-lg overflow-hidden">
        <div className="bg-[#2A2634] px-5 py-6 flex justify-between items-center">
          <div>
          ...
          <button className="py-3 px-4 bg-violet-500 hover:bg-violet-600 text-white rounded flex gap-1">
