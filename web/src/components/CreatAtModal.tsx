  ...
  return (
    <Dialog.Portal>
      ...
      <Dialog.Content className="fixed bg-[#2A2634] py-8 px-10 text-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-lg w-[480px] shadow-lg shadow-black/25">
        ...
        {/*<Dialog.Description>*/}
          <form onSubmit={handleCreateAt} className="mt-6 flex flex-col gap-2">
            ...
            <div className="flex flex-col gap-2">
              ...
              <Input name="name" id="name" placeholder="Como ti chamam dentro do Game?" />
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="flex flex-col gap-2">
                ...
                <Input name="discord" id="discord" placeholder="Usario#003400" />
                </div>
              </div>
